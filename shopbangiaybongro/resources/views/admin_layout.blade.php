            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/add-trademark-category-product')}}">Thêm thương hiệu sản phẩm</a></li>
						<li><a href="{{URL::to('/all-trademark-category-product')}}">Liệt kê thương hiệu sản phẩm</a></li>
...
<div class="footer">
			<div class="wthree-copyright">
			  ...
			  <p><a href="https://www.facebook.com/profile.php?id=100048900099498">Thanh Tâm</a></p>
			</div>
		  </div>
<!--main content end-->
</section>
