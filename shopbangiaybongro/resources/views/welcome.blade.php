					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 709 158 615</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> tamvt.21it@vku.udn.vn</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="#"> <span class="pull-right">(50)</span>Giày Nike chính hãng</a></li>
									<li><a href="#"> <span class="pull-right">(56)</span>Giày Adidas chính hãng</a></li>
									<li><a href="#"> <span class="pull-right">(27)</span>Giày Anta chính hãng</a></li>
									<li><a href="#"> <span class="pull-right">(32)</span>Giày Peak chính hãng</a></li>
									<li><a href="#"> <span class="pull-right">(5)</span>Giày Lining chính hãng</a></li>
									<li><a href="#"> <span class="pull-right">(9)</span>Nike,Adidas Replica</a></li>
									<li><a href="#"> <span class="pull-right">(4)</span>Giày bóng rổ nội địa</a></li>
								</ul>
							</div>
						</div><!--/brands_products-->
